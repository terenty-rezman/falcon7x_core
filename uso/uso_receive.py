...
uso_pushbuttons_receive_map = {
    ...
    "wc_trim_roll_right_lh": "I03_b10", # roll left + [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_roll_left_lh": "I03_b11", # roll left - [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_roll_right_rh": "I03_b12", # roll right + [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_roll_left_rh": "I03_b13", # roll right - [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_yaw_right_lh": "I03_b14", # yaw left + [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_yaw_left_lh": "I03_b15", # yaw left - [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_yaw_right_rh": "I03_b16", # yaw right + [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_yaw_left_rh": "I03_b17", # yaw right - [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    ...
    "rh_master": "I07_b09", # LH MASTER [K4 Верхний пульт] [Верхний пульт] [07 - 09 DC SUPPLY (Electrical System control panel) - ANTI-ICE]
