...
uso_pushbuttons_receive_map = {
    ...
    "wc_trim_pitch_up_lh": "I03_b07", # pitch left + [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_pitch_down_lh": "I03_b06", # pitch left - [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_pitch_up_rh": "I03_b09", # pitch right + [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_pitch_down_rh": "I03_b08", # pitch right - [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_roll_up_lh": "I03_b11", # roll left + [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_roll_down_lh": "I03_b10", # roll left - [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_roll_up_rh": "I03_b13", # roll right + [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_roll_down_rh": "I03_b12", # roll right - [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_yaw_up_lh": "I03_b15", # yaw left + [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_yaw_down_lh": "I03_b14", # yaw left - [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_yaw_up_rh": "I03_b17", # yaw right + [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    "wc_trim_yaw_down_rh": "I03_b16", # yaw right - [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [09 Пульт ручного триммирования (Manual trims)]
    ...
    "mkb_a_rh": "I04_b02",	# A [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_b_rh": "I04_b06",	# B [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_c_rh": "I04_b07",	# C [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_d_rh": "I04_c19",	# D [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_e_rh": "I04_b21",	# E [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_f_rh": "I04_a32",	# F [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_g_rh": "I04_b03",	# G [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_h_rh": "I04_b05",	# H [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_i_rh": "I04_b18",	# I [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_j_rh": "I04_c03",	# J [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_k_rh": "I04_c26",	# K [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_l_rh": "I04_b25",	# L [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_m_rh": "I05_a07",	# M [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_n_rh": "I04_b04",	# N [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_o_rh": "I04_b14",	# O [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_p_rh": "I04_b09",	# P [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_q_rh": "I04_b22",	# Q [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_r_rh": "I04_b01",	# R [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_s_rh": "I05_a01",	# S [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_t_rh": "I04_c21",	# T [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_u_rh": "I04_b11",	# U [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_v_rh": "I04_b27",	# V [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_w_rh": "I04_c31",	# W [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_x_rh": "I04_b24",	# X [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_y_rh": "I04_c27",	# Y [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_z_rh": "I04_a32",	# Z [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
    "mkb_1_rh": "I04_c18",	# 1 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_2_rh": "I04_b32",	# 2 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_3_rh": "I04_b13",	# 3 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_4_rh": "I04_b29",	# 4 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_5_rh": "I04_c17",	# 5 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_6_rh": "I05_a03",	# 6 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_7_rh": "I04_c25",	# 7 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_8_rh": "I04_c01",	# 8 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_9_rh": "I04_b10",	# 9 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_0_rh": "I04_c23",	# 0 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
    "mkb_BKUP_rh": "I04_b12",	# BKUP | VHF [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_HF_rh": "I04_c15",	# HF [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_SAT_rh": "I04_b15",	# SAT [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_ATC_DTLC_rh": "I04_c16",	# ATC DTLC [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_XPDR_rh": "I04_b17",	# XPDR [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_BKUP_NAV_rh": "I04_c22",	# BKUP | NAV [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_TERR_INHIB_rh": "I04_c26",	# TERR INHIB [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_GS_INHIB_rh": "I04_c20",	# G/S INHIB [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_EMPTY1_rh": "I04_b19",	# EMPTY 1 < [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_TRFC_rh": "I04_c29",	# TRFC [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_CRS_rh": "I04_b20",	# CRS [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_SHOW_rh": "I05_a02",	# SHOW [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_DIRTO_rh": "I04_b16",	# DIRTO [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_EMPTY2_rh": "I04_a31",	# EMPTY 2 > [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_ID_rh": "I04_c32",	# ID [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
    ...
    "mkb_CL_rh": "I05_a06",	# C/L [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
    "mkb_LEFT_arrow_rh": "I04_b08",	# LEFT arrow [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_SPACE_rh": "I04_b02",	# SPACE [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_RIGHT_arrow_rh": "I05_a05", # RIGHT arrow [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_CLR_rh": "I04_b26",	# CLR | DEL [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_SHIFT_rh": "I05_a04",	# SHIFT [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_ENTER_rh": "I04_b31",	# ENTER [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_SWAP_rh": "I04_c30",	# SWAP [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
    "mkb_multiplic_rh": "I04_b30",	# * | multiplication [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_div_rh": "I04_b19",	# / |division [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
	"mkb_min_plus_rh": "I04_c02",	#  - minus | + plus [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [13Многофункциональная клавиатура (MKB) правая]
    "mkb_a_lh": "I04_a01",	# A [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_b_lh": "I04_a05",	# B [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_c_lh": "I04_a06",	# C [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	...
	"mkb_f_lh": "I03_c31",	# F [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_g_lh": "I04_a02",	# G [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_h_lh": "I04_a04",	# H [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_i_lh": "I04_a17",	# I [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_j_lh": "I05_a22",	# J [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_k_lh": "I05_b12",	# K [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_l_lh": "I05_a12",	# L [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_m_lh": "I05_b26",	# M [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_n_lh": "I04_a03",	# N [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_o_lh": "I04_a13",	# O [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_p_lh": "I04_a08",	# P [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_q_lh": "I05_a09",	# Q [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_r_lh": "I03_c32",	# R [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_s_lh": "I05_b20",	# S [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_t_lh": "I05_b08",	# T [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_u_lh": "I04_a10",	# U [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_v_lh": "I05_a14",	# V [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_w_lh": "I05_b18",	# W [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_x_lh": "I05_a11",	# X [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_y_lh": "I05_b14",	# Y [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_z_lh": "I05_a15",	# Z [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
    "mkb_1_lh": "I05_b05",	# 1 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_2_lh": "I05_a19",	# 2 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_3_lh": "I04_a12",	# 3 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_4_lh": "I05_a16",	# 4 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_5_lh": "I05_b04",	# 5 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_6_lh": "I05_b22",	# 6 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_7_lh": "I05_b12",	# 7 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_8_lh": "I05_a20",	# 8 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
	"mkb_9_lh": "I04_a09",	# 9 [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [14 Многофункциональная клавиатура (MKB) левая]
...
uso_switches_receive_map = {
    ...
    "il_emerge_lights_off": "I08_a10", #  SWITCH OFF [K4 Верхний пульт] [Верхний пульт] [16 - 17 COCKPIT LIGHTS - INTERIOR LIGHTS + RAIN RPLNT RH]
    "il_emerge_lights_on": "I08_a09", # SWITCH ON [K4 Верхний пульт] [Верхний пульт] [16 - 17 COCKPIT LIGHTS - INTERIOR LIGHTS + RAIN RPLNT RH]
...
#    "pc_heading_lh": "A005", # Лев пед  датчик перемещений
   ...
   "pc_steer_lh": "A008", # Лев пед  датчик перемещений
   ...
   "pc_steer_rh": "A008", # Прав пед  датчик перемещений
