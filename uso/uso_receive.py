...
uso_pushbuttons_receive_map = {
    ...
    "rev_ads_left": "I03_b26",	# ADS > [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [18 (Reversion Panel)]"
    "rev_ads_right": "I03_b20",	# ADS < [K2 Средний пульт (Pedestal)] [Средний пульт (Pedestal)] [18 (Reversion Panel)]"
}
