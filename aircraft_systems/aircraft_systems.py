...
from aircraft_systems.black_screens import LeftBlackScreen, RightBlackScreen, MiddleUpBlackScreen, MiddleDownBlackScreen
...
class Systems:
    all_systems = [
        ...
        LeftBlackScreen, RightBlackScreen, MiddleUpBlackScreen, MiddleDownBlackScreen
    ]
