...
class Subscribe:
    to_subscribe = [
        ...
        (Params["sim/operation/override/override_wheel_steer"], None, "tcp"),
        (Params["sim/flightmodel2/gear/tire_steer_command_deg[0]"], 2, "udp"),
        ...
        (Params["sim/joystick/yoke_roll_ratio_copilot"], 2, "udp"),
        (Params["sim/joystick/yoke_heading_ratio"], 2, "udp"),
        (Params["sim/joystick/yoke_heading_ratio_copilot"], 2, "udp"),
        ...
        (Params["sim/cockpit2/engine/actuators/throttle_ratio[0]"], 10, "udp"), # throttle
        (Params["sim/cockpit2/engine/actuators/throttle_ratio[1]"], 10, "udp"), # throttle
        (Params["sim/cockpit2/engine/actuators/throttle_ratio[2]"], 10, "udp"), # throttle
        ...
        (Params["sim/custom/7x/z_syn_eng_start2"], None, "tcp"), # synoptic eng 2 start indication
        (Params["sim/custom/7x/z_syn_eng_start3"], None, "tcp"), # synoptic eng 3 start indication
        (Params["sim/custom/7x/z_syn_eng_ign1"], None, "tcp"), # synoptic eng 1 ign indication
        (Params["sim/custom/7x/z_syn_eng_ign2"], None, "tcp"), # synoptic eng 2 ign indication
        (Params["sim/custom/7x/z_syn_eng_ign3"], None, "tcp"), # synoptic eng 3 ign indication
        ...
        (Params["sim/cockpit2/engine/indicators/fuel_flow_kg_sec[0]"], 2, "udp"), # synoptic indicator - eng - ff
        (Params["sim/cockpit2/engine/indicators/fuel_flow_kg_sec[1]"], 2, "udp"), # synoptic indicator - eng - ff
        (Params["sim/cockpit2/engine/indicators/fuel_flow_kg_sec[2]"], 2, "udp"), # synoptic indicator - eng - ff

        (Params["sim/cockpit2/engine/indicators/oil_temperature_deg_C[0]"], 2, "udp"), # synoptic indicator - eng - oil temp
